...
public class ProfilActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _logger = new Logger(this, "ProfilActivity");
        ...
        _logger.Info("Starting ProfilManagerActivity");
    ...
    protected void onPause() {
        super.onPause();
        _logger.Info("Pausing ProfilManagerActivity");
        ctxt.mIsRunning = false;
    }

    /**
     * Erstellt/befllt die ListView, die alle Profile auf dem Bildshirm anzeigt
     */
    ...
    /**
     * Fgt den Profilen ein neues hinzu und Startet die Preferences
     */
