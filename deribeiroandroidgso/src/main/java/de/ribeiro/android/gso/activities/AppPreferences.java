...
import de.ribeiro.android.gso.dataclasses.ListEntry;
import de.ribeiro.android.gso.dataclasses.SelectOptions;
import de.ribeiro.android.gso.listener.OnCheckboxChangeListener;
import de.ribeiro.android.gso.listener.OnElementChangeListener;
import de.ribeiro.android.gso.listener.OnTypeChangeListener;
import de.ribeiro.android.gso.runnables.ErrorMessage;
import de.ribeiro.android.gso.service.AlarmStarter;
import de.ribeiro.android.gso.service.AutomuteService;
    ...
    public void run() {
        ctxt.handler.post(new Runnable() {
            ...
            public void run() {
                ...
                setupResync();
                setupCheckbox("boxHide", ctxt.mProfil.hideEmptyHours);
                setupCheckbox("boxAutoSync", ctxt.mProfil.autoSync,
                ...
                setupCheckbox("boxWlan", ctxt.mProfil.onlyWlan, new Runnable() {
                ...
                setupCheckbox("boxNotify", ctxt.mProfil.notificate);
                setupCheckbox("boxVibrate", ctxt.mProfil.vibrate);
                setupCheckbox("boxSound", ctxt.mProfil.sound);
                setupCheckbox("boxFastLoad", ctxt.mProfil.fastLoad);
