...
public class HttpSession {
    ...
    public HttpSession(String url) throws ClientProtocolException, IOException {
        _logger = new Logger(Const.APPFOLDER, "HttpSession");
        Initialize(url);
    }

    private void Initialize(String url) throws ClientProtocolException, IOException {
    ...
    public String PostRequest(String url, HttpPost post) throws ClientProtocolException, IOException {
        if (!_isInitialized)
            Initialize(url);
